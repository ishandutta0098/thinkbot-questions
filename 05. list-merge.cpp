...
Node* intersectPoint(Node* head1, Node* head2)
{
    ...
    //Two pointers ptr1 and ptr2 maintained at the head of A and B,

    Node* ptr1 = head1;
    Node* ptr2 = head2;
 

    // Invalid case: If any one of head is NULL i.e no Intersection Point
...
int main()
{
    ...
    */
    ...
    cout << "INTERSEPOINT LIST :"; //prints INTERSEPOINT LIST :15->30
